...
public class PropertiesUtils {
	...
	public PropertiesUtils(){
		...
		try {
			FileInputStream fis = new FileInputStream(new ClassPathResource("localhost.properties").getFile().getPath());
			props.load(fis);
			PropertiesUtils.LOCAL_HOST = props.getProperty("localhost");
			PropertiesUtils.LOCAL_HOST_PAGE = props.getProperty("localhostPost");
			fis.close();
	...
	public PropertiesUtils(String wly) {
		try {
	...
	public static void main(String[] args) {
		PropertiesUtils ptu = new PropertiesUtils("wly");
		//System.out.println(ptu.myip);
	}
*/
}
